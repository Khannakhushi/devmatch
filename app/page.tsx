  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-4">
      ...
      <div className="fixed inset-0 -z-10">
        <motion.div
          className="absolute left-1/4 top-1/4 size-96 rounded-full bg-blue-500/20 blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.2, 0.3, 0.2],
          }}
        ...
        />
        <motion.div
          className="absolute right-1/4 bottom-1/4 size-96 rounded-full bg-purple-500/20 blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.2, 0.3, 0.2],
          }}
      ...
      <Card className="relative w-full max-w-md overflow-hidden border-0 bg-background/80 p-6 backdrop-blur-sm">
        <motion.div
        ...
        <div className="relative flex flex-col items-center gap-8">
          ...
          >
            <h1 className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-5xl font-bold text-transparent">
              DevMatch
            </h1>
          </motion.div>
          ...
          >
            <Link href="/swipe">
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white transition-all hover:shadow-[0_0_15px_rgba(79,70,229,0.5)]"
              >
                Start Swiping
              </Button>
            </Link>
